...
namespace HuzlabBlog.Service.Describers
{
    public class CustomIdentityErrorDescriber : IdentityErrorDescriber
	{
        ...
        {
            return new IdentityError { Code = "InvalidUserName", Description = $"Belirtilen kullanıcıadı {userName} geçersizdir." };
        }
        ...
        {
            return new IdentityError { Code = "DublicateEmail", Description = $"{email} adresine ait bir hesap zaten var." };
        }
