...
namespace HuzlabBlog.Data.Migrations
{
    ...
    [Migration("20240131032555_init-email-sender-for-register")]
    partial class initemailsenderforregister
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HuzlabBlog.Entities.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "aabdfdc8-4a8b-416f-99f8-5a9c9dff8ab2",
                            Name = "SuperAdmin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "1c40d8ba-890d-4b48-b57a-7028f8eb031b",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "b97d420b-296c-4375-b28e-a7fc3710b6e2",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("HuzlabBlog.Entities.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "821de61d-9b82-4784-948b-e5d2e15d88c2",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAENOLw/0k4gGnAWI/6Z+gSFkX9azep9q8+3zV7RwLCTfIxq0RkQIJRQuq3VjJlRDc/w==",
                            PhoneNumber = "+905438018574",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "265fe2b9-07f4-4a49-bb32-22a24490166c",
                            Slug = "berkay-huz",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "b356f71c-96d9-4559-8515-6c6312af4c7d",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEJzZ2pkp2Hy6jaohIvypmRrZJX9068MAXrUOkpi3bstabzy1iTsX32P1FnbBRWAwzw==",
                            PhoneNumber = "+905524130669",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "3cb44b1a-6701-4c64-82d5-3cd151a8fd78",
                            Slug = "deneme-deneme",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("HuzlabBlog.Entities.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1cb047ec-236b-4c55-bdc4-cc31d917a3e5"),
                            CategoryId = new Guid("6f679be0-ca72-4dfc-b2bf-66e375f9cbc0"),
                            Content = "Deneme Content",
                            CreatedBy = "Berkay Huz",
                            CreatedDate = new DateTime(2024, 1, 31, 6, 25, 53, 569, DateTimeKind.Local).AddTicks(9512),
                            ImageId = new Guid("5783a0a4-0c35-4f26-a466-05636f9fee2c"),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("HuzlabBlog.Entities.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Berkay Huz",
                            CreatedDate = new DateTime(2024, 1, 31, 6, 25, 53, 570, DateTimeKind.Local).AddTicks(8419),
                            IsDeleted = false,
                            Name = "ASP.NET Core",
                            Slug = "asp.net-core"
                        });
            ...
            modelBuilder.Entity("HuzlabBlog.Entities.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Berkay Huz",
                            CreatedDate = new DateTime(2024, 1, 31, 6, 25, 53, 570, DateTimeKind.Local).AddTicks(9973),
            ...
            modelBuilder.Entity("HuzlabBlog.Entities.Entities.Setting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Berkay Huz",
                            CreatedDate = new DateTime(2024, 1, 31, 6, 25, 53, 572, DateTimeKind.Local).AddTicks(8076),
                            IsDeleted = false
                        });
                });
