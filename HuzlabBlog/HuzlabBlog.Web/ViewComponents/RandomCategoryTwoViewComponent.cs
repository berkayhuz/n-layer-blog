...
{
    public class RandomCategoryTwoViewComponent : ViewComponent
    {
        private readonly ICategoryService _categoryService;
        private readonly IArticleService _articleService;

        public RandomCategoryTwoViewComponent(ICategoryService categoryService, IArticleService articleService)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            try
            {
                ...
                {
                    var randomPosts = await _articleService.GetRandomPostsForCategory(randomCategory.Id, 4);
